...
def load_index(input_path):
    ...
    with open(input_path,encoding='UTF-8') as f:
        for i, line in enumerate(f.readlines()):        # relaions.dict和entities.dict中的id都是按顺序排列的
            ...
            rev_index[id] = rel
            entity.append(rel)
    return index, rev_index,entity


entity2id, id2entity,entity = load_index(os.path.join('entity2id.txt'))

relation2id, id2relation,_ = load_index(os.path.join('relation2id.txt'))
# print(relation2id)
